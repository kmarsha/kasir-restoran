...
<head>
  ...
  <title>Laporan PDF Cafe Bisa Ngopi</title>
</head>
<body>
  <div class="container-fluid py-4">
    <header>
      <h2 class="text-center"><img src="{{ asset('assets/img/icon1.png') }}" alt="logo" width="40" height="40"> Transaksi <i class="text-sm">(all)</i></h2>
    </header>
    <div class="row">
      <div class="col-12">
        <div class="card my-4">
